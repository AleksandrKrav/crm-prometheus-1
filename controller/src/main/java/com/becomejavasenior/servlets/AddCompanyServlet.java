...
public class AddCompanyServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            if (req.getParameter("id") == null){
                ...
                company = companyService.getById(Integer.parseInt(req.getParameter("id")));
            }
            ...
            req.getRequestDispatcher("pages/addCompany.jsp").forward(req, resp);
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (req.getParameter("company-submit") != null){
       ...
       resp.sendRedirect("addCompany?id=" + company.getId());
    }

    private void createCompany(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException, ServiceException {
        company = new Company();
