    ...
    <div class="col-md-10 main">
      <div class="panel company-panel panel-success">
        <div class="panel-heading">
          <h3 class="panel-title">Редактирование компании</h3>
        </div>
        <div class="panel-body">
          <form class="form-horizontal" id="company-edit-form" action="/editCompany" method="POST" enctype="multipart/form-data">
            <div class="col-md-6">
              <fieldset class="field-company">
                <legend>Редактирование компанию</legend>
                <div class="form-group company-name-group">
                  ...
                  <div class="col-md-8">
                    <input type="text" class="form-control" id="company-name" name="company-name"
                           value="${company.getName()}" size="30" autofocus >
                  </div>
                </div>
                  ...
                  <div class="col-md-8">
                    <select id="company-owner" class="form-control" name="company-owner">
                      <c:forEach items="${owners}" var="owner">
                        <option value="${owner.getId()}" <c:if test="${owner.id eq company.owner.getId()}">SELECTED</c:if>>${owner.getName()}</option>
                      </c:forEach>
                    </select>
                  </div>
                </div>
                <div class="form-group company-address-group">
                  ...
                  <div class="col-md-8">
                    <input type="text" class="form-control" id="company-address" name="company-address"
                           value="${company.getAddress()}" size="30" autofocus >
                  </div>
                </div>
                  ...
                  <div class="col-md-4">
                    <select id="company-phone-type" class="form-control" name="company-phone-type">
                      <c:forEach items="${phoneTypes}" var="phoneType">
                        <option value = "${phoneType.getId()}" <c:if test="${phoneType.id eq company.getPhones().iterator().next().getPhoneType().getId()}">SELECTED</c:if>>${phoneType.getName()}</option>
                      </c:forEach>
                    </select>
                  </div>
                  <div class="col-md-8">
                    <input type="text" class="form-control" id="company-phone-number" name="company-phone-number"
                           value = "${company.getPhones().iterator().next().getValue()}" size="30" autofocus >
                  </div>
                </div>
                <div class="form-group company-email-group">
                  ...
                  <div class="col-md-8">
                    <input type="text" class="form-control" id="company-email" name="company-email"
                           value="${company.getEmail()}" size="30" autofocus value  >
                  </div>
                </div>
                <div class="form-group company-web-group">
                  ...
                  <div class="col-md-8">
                    <input type="text" class="form-control" id="company-web" name="company-web"
                           value="${company.getWeb()}"  size="30" autofocus  >
                  </div>
                </div>
                <div class="form-group company-comment-group">
                  ...
                  <div class="col-md-8">
						<textarea id="company-comment" class="form-control" name="company-comment"
                                  rows="3" cols="30"><c:if test="${company.comments.size() > 0}">${company.comments.toArray()[0].getComment()}</c:if>
						</textarea>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-md-8">
                    <label>
                      ${company.files.toArray()[0].getName()}
                      <input id="files" value="${company.files.toArray()[0].getName()}" type="file" class="file" name="files" multiple="multiple">
                    </label>
                  </div>
                </div>
                <div class="form-group">
                  <div class="text-center">
                    <input id="company-submit-button" name="edit" type="submit" value="Обновить"
                           class="btn btn-primary">
                    <input id="company-delete-button" name="company-delete" type="submit" value="Удалить компанию"
